...
public class EntitySandPiles extends EntityThrowable
{
    public EntitySandPiles(World worldIn)
    {
        super(worldIn);
    }

    public EntitySandPiles(World worldIn, EntityLivingBase throwerIn)
    {
        super(worldIn, throwerIn);
    }

    public EntitySandPiles(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        if (result.entityHit != null)
        {
            ...
            new PotionEffect(MobEffects.BLINDNESS, 60*20, 5, false, true);
        }
